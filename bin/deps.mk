# Auto-generated Fortran module dependencies — regenerate with: python3 ../tools/gen_deps.py
# Run from bin/ after any USE statement changes
...
amr_step.o: clump_finder.o cooling_fine.o feedback.o flag_utils.o force_fine.o godunov_fine.o gpu_manager.o interpol_phi.o lightcone.o move_fine.o movie.o multigrid_fine_commons.o newdt_fine.o output_amr.o phi_fine_cg.o pm_parameters.o ramses_commons.o refine_utils.o rho_fine.o rt_godunov_fine.o rt_step.o sink_evolution.o sink_formation.o sink_merger.o source_hydro_fine.o star_formation.o synchro_hydro_fine.o tree_formation.o turb_driving.o turb_hydro.o update_time.o upload.o
...
clump_finder.o: amr_parameters.o boundaries.o cache.o cache_commons.o clump_merger.o marshal.o mdl.o mdl_commons.o multigrid_fine_coarse.o nbors_utils.o output_clump.o ramses_commons.o rho_fine.o
...
cooling_fine.o: amr_commons.o amr_parameters.o constants.o cooling_module.o coolrates_module.o gpu_runner.o hydro_parameters.o mdl.o mdl_commons.o neq_cooling_module.o ramses_commons.o rt_parameters.o rtz_cooling_module.o rtz_module.o
...
courant_fine.o: amr_commons.o amr_parameters.o gpu_runner.o hydro_parameters.o mdl.o mdl_commons.o ramses_commons.o
...
flag_utils.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o gpu_utils.o hilbert.o hydro_flag.o marshal.o mdl.o mdl_commons.o nbors_utils.o pm_commons.o ramses_commons.o rt_flag.o smooth.o
force_fine.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o interpol_phi.o mdl.o mdl_commons.o multigrid_fine_coarse.o nbors_utils.o phi_fine_cg.o ramses_commons.o
godunov_fine.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o hydro_commons.o hydro_parameters.o marshal.o mdl.o mdl_commons.o nbors_utils.o ramses_commons.o
...
gpu_manager.o: gpu_refine.o gpu_runner.o gpu_utils.o mdl.o mdl_commons.o ramses_commons.o
...
init_amr.o: amr_commons.o amr_parameters.o gpu_runner.o gpu_utils.o hash.o hilbert.o hydro_parameters.o mdl.o mdl_commons.o output_amr.o ramses_commons.o rt_parameters.o
...
init_neq_chem.o: amr_commons.o charge_exchange_module.o coolrates_module.o cosmic_ray_ionization_module.o neq_cooling_module.o photoionization_UVB_module.o rtz_cooling_module.o rtz_coolrates_module.o
init_part.o: amr_commons.o amr_parameters.o gpu_part.o gpu_runner.o mdl.o mdl_commons.o pm_commons.o pm_parameters.o ramses_commons.o
init_refine_adaptive.o: flag_utils.o init_part.o input_hydro_grafic.o input_part.o input_part_zoom.o ramses_commons.o refine_utils.o rho_fine.o rt_upload.o upload.o
init_refine_basegrid.o: amr_parameters.o flag_utils.o hash.o hilbert.o input_hydro_grafic.o mdl.o mdl_commons.o ramses_commons.o rho_fine.o
init_refine_ramses.o: amr_parameters.o hash.o hilbert.o hydro_parameters.o init_refine_basegrid.o input_hydro_condinit.o load_balance.o mdl.o mdl_commons.o output_amr.o ramses_commons.o read_params.o rho_fine.o
init_refine_restart.o: amr_parameters.o hash.o hilbert.o hydro_parameters.o init_refine_basegrid.o load_balance.o mdl.o mdl_commons.o output_amr.o ramses_commons.o read_params.o rho_fine.o rt_parameters.o
...
init_xion.o: amr_commons.o amr_parameters.o constants.o cooling_module.o coolrates_module.o hydro_parameters.o mdl.o mdl_commons.o neq_cooling_module.o ramses_commons.o rt_parameters.o rtz_module.o upload.o
input_hydro_condinit.o: amr_commons.o amr_parameters.o hydro_parameters.o mdl.o mdl_commons.o ramses_commons.o rtz_module.o
...
interpol_phi.o: amr_commons.o amr_parameters.o gpu_runner.o mdl.o mdl_commons.o ramses_commons.o
...
move_fine.o: amr_commons.o amr_parameters.o cache.o cache_commons.o gpu_part.o hydro_parameters.o mdl.o mdl_commons.o nbors_utils.o pm_commons.o pm_parameters.o ramses_commons.o rho_fine.o rngstream.o rt_parameters.o
...
multigrid_fine_coarse.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o hash.o hilbert.o mdl.o mdl_commons.o nbors_utils.o ramses_commons.o
multigrid_fine_commons.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o hash.o hilbert.o interpol_phi.o mdl.o mdl_commons.o multigrid_fine_coarse.o nbors_utils.o phi_fine_cg.o poisson_parameters.o ramses_commons.o
...
newdt_fine.o: amr_commons.o amr_parameters.o constants.o courant_fine.o gpu_part.o mdl.o mdl_commons.o pm_commons.o pm_parameters.o ramses_commons.o
...
output_rt.o: amr_commons.o amr_parameters.o constants.o hydro_parameters.o mdl.o mdl_commons.o ramses_commons.o rt_parameters.o rtz_module.o
phi_fine_cg.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o call_back.o gpu_runner.o interpol_phi.o mdl.o mdl_commons.o multigrid_fine_coarse.o nbors_utils.o ramses_commons.o
...
read_params.o: amr_commons.o amr_parameters.o constants.o hydro_parameters.o mdl.o mdl_commons.o movie.o ramses_commons.o read_rt_params.o rt_parameters.o rtz_module.o
read_rt_params.o: amr_parameters.o constants.o cross_sections_module.o hydro_parameters.o mdl.o movie.o ramses_commons.o rt_parameters.o rt_spectra.o
refine_utils.o: amr_commons.o amr_parameters.o boundaries.o cache.o cache_commons.o call_back.o gpu_runner.o hash.o hilbert.o hydro_parameters.o init_refine_basegrid.o init_xion.o load_balance.o marshal.o mdl.o mdl_commons.o nbors_utils.o oct_commons.o ramses_commons.o rt_parameters.o
rho_ana.o: amr_parameters.o
rho_fine.o: amr_commons.o amr_parameters.o cache.o cache_commons.o gpu_part.o gpu_runner.o hilbert.o mdl.o mdl_commons.o multigrid_fine_coarse.o nbors_utils.o pm_commons.o pm_parameters.o ramses_commons.o
...
rt_init_flow_fine.o: amr_commons.o amr_parameters.o coolrates_module.o mdl.o mdl_commons.o neq_cooling_module.o output_rt.o ramses_commons.o rt_input_condinit.o rt_parameters.o rt_spectra.o rtz_cooling_module.o
...
rt_spectra.o: amr_commons.o constants.o cross_sections_module.o hydro_parameters.o pm_commons.o rt_parameters.o rtz_module.o
...
sink_formation.o: amr_commons.o amr_parameters.o cache.o cache_commons.o clfind_commons.o clump_finder.o clump_merger.o constants.o hydro_parameters.o mdl.o mdl_commons.o output_amr.o output_clump.o output_part.o output_poisson.o pm_commons.o ramses_commons.o rho_fine.o rngstream.o
...
smooth.o: amr_parameters.o boundaries.o cache.o cache_commons.o gpu_runner.o marshal.o mdl.o mdl_commons.o nbors_utils.o ramses_commons.o
...
synchro_hydro_fine.o: amr_commons.o amr_parameters.o gpu_runner.o mdl.o mdl_commons.o ramses_commons.o
task_manager.o: amr_commons.o amr_parameters.o cache.o cache_commons.o call_back.o clfind_commons.o clump_finder.o clump_merger.o cooling_fine.o courant_fine.o feedback.o flag_utils.o force_fine.o godunov_fine.o gpu_manager.o hash.o hilbert.o init_amr.o init_hydro.o init_part.o init_refine_basegrid.o init_refine_ramses.o init_refine_restart.o init_rt.o init_time.o init_xion.o input_hydro_condinit.o input_hydro_gadget.o input_hydro_grafic.o input_part.o input_part_ascii.o input_part_gadget.o input_part_grafic.o input_part_ramses.o input_part_restart.o input_part_zoom.o interpol_phi.o lightcone.o load_balance.o mdl.o mdl_commons.o move_fine.o movie.o multigrid_fine_coarse.o multigrid_fine_commons.o newdt_fine.o output_amr.o output_clump.o output_hydro.o output_part.o output_poisson.o output_rt.o phi_fine_cg.o ramses_commons.o read_params.o refine_utils.o rho_fine.o rt_godunov_fine.o rt_init_flow_fine.o rt_input_condinit.o rt_star_feedback.o rt_upload.o rtz_module.o sink_evolution.o sink_formation.o sink_merger.o smooth.o source_hydro_fine.o star_formation.o synchro_hydro_fine.o tree_formation.o turb_driving.o turb_hydro.o turb_init.o turb_update.o update_time.o upload.o
...
tree_formation.o: amr_commons.o amr_parameters.o cache.o cache_commons.o clfind_commons.o clump_finder.o clump_merger.o constants.o hydro_parameters.o mdl.o mdl_commons.o pm_commons.o ramses_commons.o rho_fine.o rngstream.o
...
upload.o: amr_commons.o amr_parameters.o cache.o cache_commons.o gpu_runner.o hydro_parameters.o mdl.o mdl_commons.o nbors_utils.o ramses_commons.o

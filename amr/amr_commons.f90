module amr_commons
  ...
  type run_t
     ...
     integer :: part_dep_algo=2   ! GPU CIC particle deposition algorithm (1: large 27-offset, 2: medium shifted 8-offset (fastest, default), 3: small shifted 8-offset prefix-sum)

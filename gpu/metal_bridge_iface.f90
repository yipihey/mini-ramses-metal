...
module metal_bridge_iface
  ...
  interface
     ...
     subroutine mtl_gas_deposit(head, num, vol_loc, fp_scale, mass_sph, refine_on) bind(C, name="mtl_gas_deposit")
       import :: c_int, c_double
       integer(c_int), value :: head, num, refine_on
       real(c_double), value :: vol_loc, fp_scale, mass_sph
     ...
     subroutine mtl_hydro_fill_cache(head, num, interpol_var, interpol_type, smallr, gamma) &
          bind(C, name="mtl_hydro_fill_cache")
       import :: c_int, c_double
       integer(c_int), value :: head, num, interpol_var, interpol_type
       real(c_double), value :: smallr, gamma
